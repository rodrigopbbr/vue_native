  ...
  <nb-container :style="{ backgroundColor: '#fff' }">
    ...
    <nb-content padder>
      ...
      <nb-text
        ...
        contada a história do grande vilão Darth Vader.</nb-text
      >
      <nb-text>Saiba de onde ele veio e quem ele é</nb-text>
    ...
    <nb-footer>
      <nb-footer-tab>
        <nb-button active full>
          <nb-text>Trilogias Star Wars</nb-text>
        </nb-button>
      </nb-footer-tab>
    </nb-footer>
  </nb-container>
